...
exports.Ed25519Provider = void 0;
...
class Ed25519Provider {
    ...
    async publicKey(keyId) {
        ...
        const publicKey = ed25519_1.ed25519.getPublicKey(privateKeyHex);
    ...
    async sign(keyId, digest) {
        const privateKeyHex = await this.privateKey(keyId);
        return ed25519_1.ed25519.sign(digest, privateKeyHex);
    }
    /**
    ...
    async verify(digest, signatureHex, keyId) {
        ...
        return ed25519_1.ed25519.verify(signatureHex, digest, publicKeyHex);
    }
    /**
