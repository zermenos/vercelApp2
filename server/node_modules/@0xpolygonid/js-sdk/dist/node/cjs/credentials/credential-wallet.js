...
class CredentialWallet {
    ...
    constructor(_storage, _credentialStatusResolverRegistry) {
        ...
        this.createCredential = (issuer, request, schema) => {
            ...
            if (request.displayMethod?.type === verifiable_1.DisplayMethodType.Iden3BasicDisplayMethodV1 &&
                !request.context.includes(verifiable_1.VerifiableConstants.JSONLD_SCHEMA.IDEN3_DISPLAY_METHOD)) {
                request.context.push(verifiable_1.VerifiableConstants.JSONLD_SCHEMA.IDEN3_DISPLAY_METHOD);
            }
            const context = [
    ...
    buildCredentialStatus(request, issuer) {
        ...
        switch (request.revocationOpts.type) {
            case verifiable_1.CredentialStatusType.SparseMerkleTreeProof:
                return {
                    ...credentialStatus,
                    id: `${credentialStatus.id.replace(/\/$/, '')}/${credentialStatus.revocationNonce}`
                };
            case verifiable_1.CredentialStatusType.Iden3ReverseSparseMerkleTreeProof:
                return {
                    ...credentialStatus,
            ...
            case verifiable_1.CredentialStatusType.Iden3OnchainSparseMerkleTreeProof2023: {
                const issuerId = js_iden3_core_1.DID.idFromDID(issuer);
                const chainId = (0, js_iden3_core_1.getChainId)(js_iden3_core_1.DID.blockchainFromId(issuerId), js_iden3_core_1.DID.networkIdFromId(issuerId));
                const searchParams = [
