...
export const registerNetwork = (network) => {
    NetworkId[network] = network;
};
export const registerDidMethod = (method, byte) => {
 ...
 * @returns {void}
 */
export const registerChainId = (blockchain, network, chainId) => {
 ...
 * @returns {number}
 */
export const chainIDfromDID = (did) => {
